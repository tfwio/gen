...
namespace GeneratorApp
{
  static class Actions {
        ...
        string output)
    {
      ...
      Logger.Error(ConsoleColor.Magenta,
        "lodaded: datafile", "file={0}, absolute={1}, conf-dir={2}",
  ...
  internal sealed class Program
  {
    ...
    private static void Main(string[] args)
    {
      ...
      //Console.WriteLine();
      Actions.Generate(results.Value.Schema, results.Value.DataSetName, results.Value.TemplateName, results.Value.ExplicitOutputFile??results.Value.ImplicitOutputFile);
