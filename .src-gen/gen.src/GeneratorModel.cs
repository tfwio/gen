...
namespace GeneratorApp
{
	...
	{
		public GeneratorModel(GeneratorConfig conf)
		{
			Configuration = conf;
		}
		public GeneratorModel(string configFile)
		//	: this(GeneratorConfig.Load(configFile))
		{
			Configuration = GeneratorConfig.Load(configFile);
		}
		public GeneratorModel(string fileSchematic, string fileTemplates)
		//	: this(new GeneratorConfig() { datafile=fileSchematic, templatefile=fileTemplates })
		{
