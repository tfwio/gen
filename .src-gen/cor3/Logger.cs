...
namespace System
{
    ...
    [Conditional("CONSOLE")]
    static public void LogB(string title, string filter, params object[] message)
    {
      Error(MessageType.Blue, title, filter, message);
    }
    static public void LogR(string title, string filter, params object[] message)
    {
