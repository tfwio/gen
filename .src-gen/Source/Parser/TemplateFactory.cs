...
namespace Generator.Parser
{
  static public class TemplateFactory_NonStatic
  {
    ...
    static public string Gen_Pass2(TemplateModel view)
    {
      ...
      Logger.LogM("TF.Generate[a]", "T: {0}, TT: {{{1}, {2}}}", view.T.Name, view.TT.Group, view.TT.Alias);
  ...
  static public class TemplateFactory
  {
    ...
    static public string Gen_Pass2(TemplateModel view)
    {
      ...
      Logger.LogM("TF.Generate[b]", "T: {0}, TT: {{{1}, {2}}}", view.T.Name, view.TT.Group, view.TT.Alias);
